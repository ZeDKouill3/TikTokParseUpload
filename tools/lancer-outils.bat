...
set PY38=C:\Program Files\Python\Python38\python.exe
...
if errorlevel 1 (
  ...
  start "px proxy" /min "%PY38%" -m px -p 3128 -u UP60041549 -n ONE -w -a http://proxy_emea.safran:8080
) else (
...
start "ank-viz" /min "%PY38%" "%VIZ%" --repo "%REPO%"
:fin
endlocal
